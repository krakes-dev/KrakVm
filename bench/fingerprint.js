...
function getBrowserFingerprint() {
    ...
    if (typeof navigator !== 'undefined') {
        fp += navigator.userAgent || ""; fp += "|";
        fp += navigator.language || ""; fp += "|";
        fp += navigator.platform || ""; fp += "|";
        fp += navigator.hardwareConcurrency || ""; fp += "|";
        fp += navigator.deviceMemory || ""; fp += "|";
    }
    ...
    if (typeof Intl !== 'undefined' && Intl.DateTimeFormat) {
        fp += Intl.DateTimeFormat().resolvedOptions().timeZone + "|";
    }
    ...
    if (typeof document !== 'undefined') {
        ...
        if (canvas.getContext) {
            ...
            ctx.fillStyle = "#069";
            ctx.fillText("Browser Fingerprint Hash", 2, 15);
            ctx.fillStyle = "rgba(102, 204, 0, 0.7)";
            ctx.fillText("Browser Fingerprint Hash", 4, 17);
            fp += canvas.toDataURL() + "|";
        }
    }
    return fp;
...
var fingerprintRaw = getBrowserFingerprint();
var userHash = sha1(fingerprintRaw);

if (typeof console !== 'undefined') {
    console.log("Raw Fingerprint Data:", fingerprintRaw);
